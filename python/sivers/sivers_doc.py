class SiversDocClass:
    ...
    tx_alc_pdet_hi_offs_th_help = (
        "TX ALC power detector Hi Threshold offset from Lo Threshold (4:0)"
    )
    ...
    vco_tune_freq_cnt_help = (
        "VCO Tune Frequency Count. (Read only)\nBits\n11:0\tFrequency count value"
    )
    ...
    rx_bb_biastrim_help = (
        "Fine trim bias for BB VGA1, VGA2\n\nBits 2:0 value(VGA1)\n000\tNominal bias current\n001\t-4% bias current\n...\n111\t-28% bias current\n\nBits 5:3 value (VGA2)\n000\tNominal \
    bias current\n001\t-4% bias current\n...\n111\t-28% bias current"
    )
    ...
    trx_soft_max_state_help = (
        "TX/RX Soft switch maximum/last state\nBits\n2:0\tMaximum/Last state for soft switch"
    )
    trx_tx_on_help = (
        "TX bias on control when TX mode is active\n\nBits\n20\tEnable TX PA bias loop\n19\tEnable TX BF VGAs\n18\tEnable TX Q Baseband\n17\tEnable TX I Baseband\n16\tEnable TX mixer- and LO-buffer, \
    RF VGA and common PA\n15:0\tEnable TX BF ports 15-0"
    )

    trx_tx_off_help = (
        "TX bias on control when TX mode is inactive\n\nBits\n20\tEnable TX PA bias loop\n19\tEnable TX BF VGAs\n18\tEnable TX Q Baseband\n17\tEnable TX I Baseband\n16\tEnable TX mixer- and LO-buffer, \
    RF VGA and common PA\n15:0\tEnable TX BF ports 15-0"
    )
